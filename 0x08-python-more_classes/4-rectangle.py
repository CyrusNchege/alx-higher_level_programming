...
class Rectangle:
    """
    This class defines a rectangle by private instance attributes.
    """
    ...
    def __repr__(self):
        '''
        Returns string representation of the Rectangle that can
        be used to create a new instance of the class.
        '''
